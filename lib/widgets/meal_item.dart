 ...
 // final Function removeItem;
  ...
  void selectMeal(BuildContext context) {
    ...
    //        removeItem(result);
        ...
        }); //we pass these args because we want to know which meal to display
  }
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                          '$affordabilityText'), // Text('Affordability: $affordabilityText'), böyle yazmak isteseydim nasıl sıkıştırırdım
                    ],
                  ),
                ],
              ),
